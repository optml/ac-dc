...
#include "Example_2D_TTD.cu"

#include "Example_MultiGPUSolver.cu"
////////////////////////////////////////////////////////////////////////////////
// Program main

int main(int argc, char** argv) {
	cout
			<< "This is a demo program, where you can choose from multiple examples:\n";
	cout << "1. 2D Truss Topology Design \n";
	cout << "2. 3D Truss Topology Design \n";
	cout << "3. SVM \n";
	cout << "4. Large SVM - need 3 GPU devices \n";
	...
	case 1:
		cout << "2D Truss Topology Design \n";

		cout << "Example for 2D Truss Topology Design - start \n";
		runThrust2DExample(100, 100, 2, 15.05, .001);
		cout << "Example for 2D Truss Topology Design - finish \n";
	...
	case 4:
		cout << "Large SVM - need 3 GPU devices \n";
		runMultiGPUExampleForSVM();
		break;

	default:
		cout << "D Truss Topology Design \n";
		break;
	}
